...
* now the plugin works with multiple robots
* added a IMU sensor plugin that inherits from SensorPlugin
* Contributors: Adam Allevato, Alessandro, Alessandro Settimi, Christoph Rist, Dave Coleman, Enrique Fernandez, Jose Luis Rivero, Kei Okada, Lucas Walter, Shohei Fujii, Steven Peters, Yuki Furuta, nate koenig
